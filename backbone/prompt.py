...
class CodaPrompt(nn.Module):
    def __init__(self, emb_d, n_tasks, prompt_param, key_dim=512):
        super().__init__()
        self.task_count = 0
        self.emb_d = emb_d
        self.key_d = key_dim
...
class Prompt(nn.Module):
    ...
    def forward(self, x_embed, prompt_mask=None, cls_features=None):
        ...
        if self.prompt_pool:
            ...
            out['prompt_norm'] = prompt_norm  # pool_size, C
            out['x_embed_norm'] = x_embed_norm  # B, C
            out['similarity'] = similarity  # B, pool_size
